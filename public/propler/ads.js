...
function loadAdCode() {
      ...
      // Append the first ad script to the body
      document.body.appendChild(adScript);
    
      // Second ad script (integrated from your request)
      var secondAdScript = document.createElement('script');
      secondAdScript.innerHTML = "(function(d,z,s){s.src='https://'+d+'/401/'+z;try{(document.body||document.documentElement).appendChild(s)}catch(e){}})('groleegni.net',8640299,document.createElement('script'))";
    
      // Append the second ad script to the body
      document.body.appendChild(secondAdScript);
  }
